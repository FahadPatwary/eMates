...
public class InputCost2 {
    ...
    private void loadDataFirstTime() {
        try (BufferedReader br = new BufferedReader(new FileReader("C:\\Users\\Dell\\Desktop\\eMates\\src\\main\\resources\\com\\example\\emates\\expenseData.txt"))) {
            String line;
    ...
    private void updateTotalAmountDisplay() {
        double totalAmount = paymentsList.stream()
                ...
                .sum();
        try{
            File file = new File("C:\\Users\\Dell\\Desktop\\eMates\\src\\main\\resources\\com\\example\\emates\\totalExpenses.txt");
    ...
    private void savePayment() {
        ...
        try (BufferedWriter bw = new BufferedWriter(new FileWriter("C:\\Users\\Dell\\Desktop\\eMates\\src\\main\\resources\\com\\example\\emates\\expenseData.txt", true))) {
    ...
    private void updateDataFile() {
        try (BufferedWriter bw = new BufferedWriter(new FileWriter("C:\\Users\\Dell\\Desktop\\eMates\\src\\main\\resources\\com\\example\\emates\\expenseData.txt"))) {
